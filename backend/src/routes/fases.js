...
const { getFases, createFase, getFase, updateFase, updateFaseMediciones, updateFaseObservaciones, updateFaseGrupos, deleteFase } = require('../controllers/fases.controller');
